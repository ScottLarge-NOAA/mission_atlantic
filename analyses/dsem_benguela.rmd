...
sem_simple <- "
  ...
  # 
  # ## Removals
  # anchovy_catches -> biomass_Anchovy, 0, catchesA_to_biomassA
  # anchovy_catches -> biomass_Sardine, 0, catchesA_to_biomassS
  # sardine_catches -> biomass_Sardine, 2, catchesS_to_biomassS
  # 
  ## AR
  ...
  copepod_AB -> copepod_AB, 1, AR5, 0.001
  calanus_AB -> calanus_AB, 1, AR6, 0.001
  smcopepod_AB -> smcopepod_AB, 1, AR7, 0.001
  
  # chla_SB -> chla_SB, 1,  AR8, 0.001
  # mdlgzp_SB -> mdlgzp_SB, 1, AR9, 0.001
  # smallzp_SB -> smallzp_SB, 1, AR10, 0.001
...
sem_dat_simple <- sem_dat_full %>% 
  select(year, upwelling_SB, upwelling_AB, sst_AB, sst_SB, 
         chla_SB, chla_AB,
         # cap, tsa, agulhas_gradient, 
         smcopepod_AB, calanus_AB, copepod_AB,
         mdlgzp_SB, smallzp_SB, copepodabund_SB, accs_SB,
