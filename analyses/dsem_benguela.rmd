...
-   Ecosystems are comprised of many interacting processes.
-   Causal models help to identify the magnitude and direction of direct and indirect effects between interacting variables (find a few citations within [@thorson2024]).
-   Identifying meaningful indicators is important for EBFM [@rice2005].
-   IEA as tool for confronting trade-offs between multiple EBFM objectives [@levin2009].
-   Here we aim to disentangle multiple drivers of ecosystem change to evaluate indicators for potential use within an IEA framework.
-   Southern Benguela is an important and dynamic system
    -   Environmental drivers:
        -   Thermal spawning area (TSA )
        ...
        -   Cape Agulhas Pressure (CAP index, see Figure \@ref(fig:ag-plot) )
            -   The Agulhas Bank (AB) is ecologically and economically important since it comprises the major spawning grounds for numerous fish species which recruit to the west coast ([@hutchings2009, @kirkman2016]).
            -   Efficient transport between the spawning grounds and the nursery area ([@agenbag1996]). Increased wind velocity (high CAP index) over the anchovy transport area (Cape Point to Cape Columbine) is likely to result in improved transport. A high CAP anomaly for September--December should result in more efficient transport to the productive nursery grounds.
            -   Decadal signal in atmospheric pressure (@roy2007) seen in NCEP/NCAR reanalysis data
        -   Upwelling - @vanderlingen2006
            ...
            -   @vanderlingen2006 hypothesized that larger zooplankton are be more abundant when upwelling is stronger and smaller zooplankton more abundant when upwelling is weaker, which could suggest that sardine diet is negatively influenced by upwelling.
        -   Phytoplankton
...
-   SST
    ...
    -   Anchovy thermal spawning suitability area (TSA; Richardson et al., 1998)
    -   Standardized Cape Agulhas Pressure anomaly (CAP; Agenbag 1996) and Roy (2007)
    -   Mean sea temperature (°C) near the surface (5 m depth) (tempsurf; Huggett 2023)

-   Upwelling

    -   Cumulative coastal South Benguela and Agulhas Bank upwelling from December to March (upwelling_SB and upwelling_AB; Lamont et al 2018)

-   Primary Production

    -   Southern Benguela -
        -   Mean chlorophyll a (mg m^-3^) from December to February (chla_SB; Lamont et al 2019)
        -   Mean fractional contribution of microphytoplankton (micro_SB), nanophytoplankton (nano_SB), and picophytoplankton (pico_SB) from December to February (Lamont et al 2019)
    -   Agulhas Bank -
        -   Mean chlorophyll a (mg m^-3^) from December to February (Lamont et al 2019)
        -   Mean fractional contribution of microphytoplankton (micro_AB), nanophytoplankton (nano_AB), and picophytoplankton (pico_AB) from December to February (chla_AB; Lamont et al 2019)
        -   *in situ* Mean chlorophyll a (mg m^-3^) near the surface (5 m depth) from March to May (fluosurf; Huggett 2023)

-   Zooplankton

    -   Southern Benguela - <!-- * Zooplankton samples collected in St. Helena Bay between 1951 and 1996, specifically during austral autumn (April-June), when peak recruitment of anchovy and sardine occurs, were analysed in terms of abundance, species and size composition of the copepod community following a standard, quantitative protocol (see Verheye et al., 1998). -->

        -   zooplankton biomass anomaly by species and size composition from November and December (small zooplankton = smallzp_SB, medium and large copepods = mdlgzp_SB; Huggett 2009), copepod abundance (log(n m\^-2 +1); Verheye et al., 2016), and Average Copepod Community Size index (ACCS; Verheye et al., 2016)

    -   Agulhas Bank -

        -   Mean integrated total copepod biomass (mg C m^-2^) in the upper 200 m of the water column (total_mgC_m2; Hugget et al 2023)
        -   Mean integrated biomass (mg C m^-2^) of *Calanus agulhensis* (all stages) in the upper 200 m of the water column (Cal_mgC_m2; Hugget et al 2023)
        -   Mean integrated biomass (mg C m^-2^) of small calanoid copepods (mainly Paracalanidae and Clausocalanidae) in the upper 200 m of the water column (SmCal_mgC_m2; Hugget et al 2023)
        -   Mean integrated biomass (mg C m^-2^) of Oithonidae in the upper 200 m of the water column (Oithona_mgC_m2; Hugget et al 2023)
        -   Mean integrated biomass (mg C m^-2^) of Oncaeidae in the upper 200 m of the water column (Oncaea_mgC_m2; Hugget et al 2023)
...
-   Fishing
    ...
    -   Small pelagic catches occur throughout the year
...
```{r ag-plot2, include=TRUE, fig.cap = "test"}
